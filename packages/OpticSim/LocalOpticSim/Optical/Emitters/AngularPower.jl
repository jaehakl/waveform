...
Emitters.apply(::Lambertian, ::Transform, power::Real, ::LocalOpticSim.Ray{<:Real,3}) = power
...
function Emitters.apply(d::Cosine, tr::Transform, power::Real, ray::LocalOpticSim.Ray{<:Real,3})
    cosanglebetween = dot(LocalOpticSim.direction(ray), forward(tr))
...
function Emitters.apply(d::Gaussian, tr::Transform, power::Real, ray::LocalOpticSim.Ray{<:Real,3})
    l = dot(LocalOpticSim.direction(ray), right(tr))
    m = dot(LocalOpticSim.direction(ray), up(tr))
