...
export RAY_OFFSET, POWER_THRESHOLD, TRACE_RECURSION_LIMIT
export quadraticroots, NaNsafeatan, NaNsafeasin, NaNsafeacos
export Sphere, Plane, Cylinder, Cuboid, Ray
export FresnelInterface, opaqueinterface
export ParaxialLensRect, reflectiveinterface, Rectangle, LensAssembly, CSGOpticalSystem, detectorimage, trace, OpticalRay
export OpticalRayEmitterPoint, OpticalRayEmitterLine, OpticalRayEmitterCircle, OpticalRayEmitterSphere, OpticalRayEmitterCylinder, OpticalRayEmitterCone
