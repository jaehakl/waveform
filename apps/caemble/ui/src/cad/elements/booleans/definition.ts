...
export const unionManifest = {
  tag: 'union', category: 'boolean', syntax: '<union>...</union>', summary: '같은 Material의 자식 solid를 합칩니다.',
} as const satisfies CadElementManifest<'union'>
export const subtractManifest = {
  tag: 'subtract', category: 'boolean', syntax: '<subtract>base cutter...</subtract>', summary: '첫 solid에서 나머지 solid를 뺍니다.',
} as const satisfies CadElementManifest<'subtract'>
export const intersectManifest = {
  tag: 'intersect', category: 'boolean', syntax: '<intersect>shapeA shapeB...</intersect>', summary: '모든 자식 solid의 교집합을 구합니다.',
