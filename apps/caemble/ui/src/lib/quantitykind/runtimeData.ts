...
const module = import.meta.env.MODE === 'test'
  ? await import('./data')
  : await import(
      /* @vite-ignore */ `/assets/quantity-kind-data-${QUANTITY_KIND_DATA_VERSION}.js`
    ) as Readonly<{ quantityKindData: QuantityKindData }>
