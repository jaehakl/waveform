...
describe('App workspace', () => {
  ...
  it('normalizes old and unknown hashes to Viewer and keeps the independent Experiment example', () => {
    ...
    expect(defaultExperimentCode).toContain("label: 'Centerline profile'")
    expect(defaultExperimentCode).toContain('shape: [3]')
    expect(defaultExperimentCode).toContain("label: 'Layer field'")
    expect(defaultExperimentCode).toContain('shape: [2, 3]')
