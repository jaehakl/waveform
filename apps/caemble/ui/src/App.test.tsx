...
describe('App workspace', () => {
  ...
  it('normalizes old and unknown hashes to Viewer and keeps the independent Experiment example', () => {
    ...
    expect(defaultExperimentCode).toContain("unit: 'A/m2'")
    ...
    expect(defaultExperimentCode).toContain('gridShape: [100, 41, 41]')
    expect(defaultExperimentCode).toContain("crossSectionPosition: { type: 'float', value: 0.35 }")
