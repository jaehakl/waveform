...
if (quantityKindNames.length !== 1_233) {
  throw new Error(`QuantityKind data must contain exactly 1,233 entries; found ${quantityKindNames.length}.`)
}
...
await Promise.all([
  ...
  emit(
    'src/material/material_parameter_catalog_v0.0.0.md',
  ...
  emit(
    'src/material/material_model_catalog_v0.0.0.md',
