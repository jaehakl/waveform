...
from models import GetListRequestBase, GetListResponseBase, SetupBase, UpsertResponseBase, UserData
...
CRUD_SPEC = CrudSpec(model=Setup, schema=SetupBase)
...
async def upsert_setups(
    items: list[SetupBase],
    db: AsyncSession = Depends(get_db),
