...
from db import MaterialParameter
from models import GetListRequestBase, GetListResponseBase, MaterialParameterBase, UpsertResponseBase, UserData
from user_auth.routes import get_db
from user_auth.utils.auth_wrapper import require_roles
from utils.crud import CrudSpec, delete_items, get_list_response, upsert_items


router = APIRouter(prefix="/material_parameter", tags=["material_parameter"])
CRUD_SPEC = CrudSpec(model=MaterialParameter, schema=MaterialParameterBase)
