...
from models import ExperimentBase, GetListRequestBase, GetListResponseBase, UpsertResponseBase, UserData
...
CRUD_SPEC = CrudSpec(model=Experiment, schema=ExperimentBase, tree_parent_field="parent_id")
