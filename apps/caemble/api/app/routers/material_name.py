...
from db import MaterialName
from models import GetListRequestBase, GetListResponseBase, MaterialNameBase, UpsertResponseBase, UserData
from user_auth.routes import get_db
from user_auth.utils.auth_wrapper import require_roles
from utils.crud import CrudSpec, delete_items, get_list_response, upsert_items


router = APIRouter(prefix="/material_name", tags=["material_name"])
CRUD_SPEC = CrudSpec(model=MaterialName, schema=MaterialNameBase)
