...
from models import GeometryBase, GetListRequestBase, GetListResponseBase, UpsertResponseBase, UserData
...
CRUD_SPEC = CrudSpec(model=Geometry, schema=GeometryBase, tree_parent_field="parent_id")
...
async def upsert_geometries(
    items: list[GeometryBase],
    db: AsyncSession = Depends(get_db),
